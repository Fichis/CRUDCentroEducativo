 ...
 * @author pc
 */
public class jfrUnidad extends javax.swing.JFrame {

    /**
     * Creates new form jfrUnidad
     */
    public jfrUnidad() {
        initComponents();
        configTable();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("idCurso");

        jLabel5.setText("idTutor");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jfrUnidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
